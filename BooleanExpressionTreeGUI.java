 ...
 * BoolExpNode subclasses are made
 *
 * @author sehall
 */
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == evaluateButton) {   //finish this button event to handle the evaluation and output to infix of the tree 
            if (root == null) {
                ...
                JOptionPane.showMessageDialog(this, BooleanExpressionTreeBuilder.toInfixString(root)+"="+root.evaluate(), "Evaluation",
            ...
            root = BooleanExpressionTreeBuilder.buildExpressionTree(c);
